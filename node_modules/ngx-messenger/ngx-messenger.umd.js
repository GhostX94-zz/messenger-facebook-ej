(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'moment'], factory) :
	(factory((global['ngx-messenger'] = {}),global.core,global.common,global.moment));
...
var MessengerChatBoxComponent = (function () {
    function MessengerChatBoxComponent() {
        ...
        this.onGoBack = new core.EventEmitter();
    }
    /**
     * @param {?} text
     * @return {?}
    ...
    MessengerChatBoxComponent.propDecorators = {
        ...
        "messageInput": [{ type: core.ViewChild, args: ['messageInput',] },],
        "currentUserId": [{ type: core.Input },],
        "conversation": [{ type: core.Input },],
        "isFullScreen": [{ type: core.Input },],
        "onSend": [{ type: core.Output },],
        "onGoBack": [{ type: core.Output },],
    };
...
exports.MessengerChatBoxComponent = MessengerChatBoxComponent;
exports.MessengerMessageComponent = MessengerMessageComponent;
exports.DynamicHeightDirective = DynamicHeightDirective;
